...
class Ui_info_grupo(object):
    def setupUi(self, info_grupo):
        ...
        self.btSalir.setGeometry(QtCore.QRect(130, 550, 121, 24))
        self.btSalir.setObjectName(_fromUtf8("btSalir"))
        self.btdiagramabarras = QtGui.QPushButton(info_grupo)
        self.btdiagramabarras.setGeometry(QtCore.QRect(200, 490, 141, 24))
        font = QtGui.QFont()
        ...
        self.btenviados.setGeometry(QtCore.QRect(50, 520, 121, 24))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.btrecibidos.setGeometry(QtCore.QRect(200, 520, 121, 24))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.bteliminarintegrante.setGeometry(QtCore.QRect(40, 490, 141, 24))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.btAbandonargrupo.setGeometry(QtCore.QRect(200, 460, 141, 24))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_3.setGeometry(QtCore.QRect(40, 310, 171, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.listIntegrantes.setGeometry(QtCore.QRect(40, 330, 292, 114))
        font = QtGui.QFont()
        ...
        self.btAgregar.setGeometry(QtCore.QRect(40, 460, 141, 24))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.txtGrupo.setEnabled(True)
        self.txtGrupo.setGeometry(QtCore.QRect(100, 40, 231, 20))
        self.txtGrupo.setReadOnly(False)
        ...
        self.btGuardar = QtGui.QPushButton(info_grupo)
        self.btGuardar.setGeometry(QtCore.QRect(40, 270, 131, 35))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, info_grupo):
        ...
        self.btGuardar.setText(_translate("info_grupo", "Guardar Cambios", None))
